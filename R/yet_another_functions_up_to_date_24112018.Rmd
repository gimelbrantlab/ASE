...
```{r}
sapply(1:4, function(i){sum(PerformDiffAIAnalysisFor2Conditions(inDF18, 
                                                                vect1CondReps=2:(2+i), 
                                                                vect2CondReps=7:(7+i), 
                                                                Q=0.95)$diffAI)})

lapply(2:6, function(i){
  combn(1:6, i, function(c1){
    combn(1:6, i, function(c2){
      print(paste(c1, c2))
...
repnumNnumberdiffaiS10S100 = sapply(2:5, function(i){
  combs = combn(1:6, i)
